...
export const createPost = async (req, res, next) => {
    try {
        ...
        //description is compulsory but image is not
        if (!description) {
...
export const getPosts = async (req, res, next) => {
    try {
      ...
      // if search is done then find the post according to search query else find all posts from friends
  ...
  export const likePostComment = async (req, res, next) => {
    ...
    //id is comment id, rid is comment reply id


    //if rid is null, then that means user is trying to like a comment
    try {
      ...
      //if rid is not null, then that means user is trying to like reply of a comment
      else {
